...
<div class="row">
    <div class="col-md-12">
        <div class="white-box">
            <div class="mb-3">
                <a href="/dashboard/menu/create" class="btn btn-success text-white shadow-none">Tambah Menu</a>
                <a href="/menu/export" class="btn btn-info text-white shadow-none ms-2">Export (Excel)</a>
            </div>
            <form>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                  ...
                                                  <p class="text-nama m-0"><b>Nama Menu</b> {{ $menu->nama_menu }}</p>
                                                  <p class="text-username m-0"><b>Harga</b> Rp {{ number_format($menu->harga) }}</p>
                                                </div>
